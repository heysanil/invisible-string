 ...
 * `createDb`, the lock factory), so the N1 and N2(a) cases run verbatim
 * against the pre-fix code and FAIL there — the reversion proof; N2(b)'s
 * sweeper is new surface.
 */
