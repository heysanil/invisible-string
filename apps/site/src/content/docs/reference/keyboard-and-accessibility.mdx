...
| `@` reference popup (workflow instructions editor) | `Enter` / `Tab` | Accept the highlighted reference |
...
| A card radio-group (e.g. the workflow editor's Agent picker) | Arrow keys / `Home` / `End` | Move focus and selection among cards |
